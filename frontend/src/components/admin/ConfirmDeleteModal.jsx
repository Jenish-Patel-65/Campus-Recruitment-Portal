...
const ConfirmDeleteModal = ({ isOpen, onClose, student, onSuccess }) => {
        ...
        <div className="p-6">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500">
              Are you sure you want to delete <strong>{student.name}</strong> ({student.student_id})? 
              This action cannot be undone and will permanently remove their academic profile and user account.
            </p>
          </div>
        </div>
