...
const ConfirmOpportunityDeleteModal = ({ isOpen, onClose, opportunity, onSuccess }) => {
  ...
  const handleDelete = async () => {
    setLoading(true);
    try {
      await api.delete(`/admin/opportunities/${opportunity.id}`);
        ...
        <div className="p-6">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500">
              Are you sure you want to delete <strong>{opportunity.company_name} - {opportunity.role}</strong>? 
...
export default ConfirmOpportunityDeleteModal;
